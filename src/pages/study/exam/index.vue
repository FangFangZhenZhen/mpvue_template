...
<script>
  ...
  import ScrollList from '@/mixin/ScrollList'//引入下拉刷新&滚动加载mixin组件
  ...
  export default {
    ...
    data () {
      return {
        ...
        testNumber     : [],
        scrollApi      : '/puzzle/api/organize/app/answer/paper/list/listByStaff',   //设置mixnins组件对应值
        scrollOutParams: { //设置mixnins组件对应值
          paperType: 100
        }
      }
    },
    mixins: [ScrollList],   //声明mixins
    onLoad () {
      this.getTestNumber()
    },
    methods: {
